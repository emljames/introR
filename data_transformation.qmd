...
These instructions assume you have just followed the Data Cleaning content. If you have arrived here separately and wish to run the examples yourself, make sure you load the *tidyverse* package and the data as per the set up instructions there.
:::
...
![[Artwork by \@allison_horst](https://x.com/allison_horst)](images/mutate.png){fig-alt="Cartoon of cute fuzzy monsters dressed up as different X-men characters, working together to add a new column to an existing data frame. Stylized title text reads “dplyr::mutate - add columns, keep existing.”"}
