...
There are many jazzy features of RMarkdown that we won't have time to go into today, but we'll touch base on this at the end of the session to discuss why RMarkdown can be useful to structure and share your code. For now, let's use this template file to [wrangle some data](https://emljames.github.io/introR/data_wrangling.html)!
