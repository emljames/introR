...
But why not just type 5\^2? The reason variables are useful is that we can change their values, or include many numbers in them. Let’s make a new variable called ‘b’, by typing:
